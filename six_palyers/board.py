...
class Board:
    ...
    def check_win(self):
        """
        Returns the winner given the current board state; 0 if the game is still ongoing.
        Each player wins by moving all their checkers to their designated target region.
        """
        cur_board = self.board[:, :, 0]
        
        # Define the target regions for each player
        # These regions should be updated according to your board setup and rules
        target_regions = {
        ...
        for player, target_region in target_regions.items():
            win = True
            for pos in target_region:
                if cur_board[pos] != player:
                    win = False
                    break
            if win:
                return player
    ...
    def player_progress(self, player_id):
        """
        Given player_id, return the number of its checkers having reached the target region.
        """
        cur_board = self.board[:, :, 0]
        ...
        for pos in target_regions[player_id]:
            if cur_board[pos] == player_id:
    ...
    def player_forward_distance(self, player_id):
        ...
        # Define the starting regions for each player
        starting_regions = {
            PLAYER_ONE: [(0, 12), (1, 11), (1, 12), (2, 10), (2, 11), (2, 12), (3, 9), (3, 10), (3, 11), (3, 12)],
            PLAYER_TWO: [(4, 4), (5, 4), (4, 5), (6, 4), (5, 5), (4, 6), (7, 4), (6, 5), (5, 6), (4, 7)],
            PLAYER_THREE: [(12, 0), (12, 1), (11, 1), (12, 2), (11, 2), (10, 2), (12, 3), (11, 3), (10, 3), (9, 3)],
            PLAYER_FOUR: [(16, 4), (15, 5), (15, 4), (14, 6), (14, 5), (14, 4), (13, 7), (13, 6), (13, 5), (13, 4)],
            PLAYER_FIVE: [(12, 12), (11, 12), (12, 11), (10, 12), (11, 11), (12, 10), (9, 12), (10, 11), (11, 10), (12, 9)],
            PLAYER_SIX: [(4, 16), (4, 15), (5, 15), (4, 14), (5, 14), (6, 14), (4, 13), (5, 13), (6, 13), (7, 13)]
        }

        for checker_id, checker_pos in checkers_pos.items():
            # Calculate the distance between the current position and the starting position
            start_pos = starting_regions[player_id][checker_id]
            distance += np.linalg.norm(np.array(checker_pos) - np.array(start_pos))
